...
Updated September 13, 2026 after ENG-005b / PR #24. The board is [TASKS.md](TASKS.md); workflow is [PLAN.md](PLAN.md).
...
- Claude's **L-202-08/09 finishing pass is reviewed** at PR #17 head `6f83285`; the latest merge only brings in reviewed shared app work through PR #24. The lesson JSON and six lesson assets remain identical to reviewed ART-003 commit `6d3019b`. Both lessons and ART-003 remain REVIEW, unmerged for Dave's theology/art approval and pilot gates. Storage 47, lesson browser 20, foundation QA and 72 image references pass. Fresh phone/laptop checks cover art, diagrams, reduced motion and the quiet-save header. Production compression remains PERF-001. [Evidence and prompts](logs/2026-09-12-ART-003-codex.md). Do not overwrite the new art.
...
Claude's latest PR #17 head is `6f83285d61e92882a9d4fc2fde377f366b00c7ad`, still open and unmerged. The latest commit normally merges shared main through PR #24 so Dave's review preview no longer shows the routine save banner. Coordinator compared both lesson JSON files, both diagrams and all four story PNGs against reviewed ART-003 commit `6d3019b`: no differences. No repeated lesson editing is needed.
