...
1. **ENG-005:** cleared to start after REV-002. Add truthful save feedback and safe recovery, preserving the failed-load guard.
2. **ENG-006:** backup/restore follows ENG-005; keep this separate from the feedback packet.
...
| [ ] | ENG-005 | REVIEW | DiscipleshipBot / cursor/eng-005-save-feedback-2d2c / 2026-09-12 | ENG-001 | Add Saving/Saved/Could not save feedback and preserve edits on storage failure. Verify quota/unavailable-storage behavior and recovery. Preserve the REV-001 failed-load write guard. Explain when edits are only in memory; offer recovery without overwriting the unreadable raw copy. Questions, checklists, commitments, completion, and reading notes are covered with store-specific status. Evidence: logs/2026-09-12-ENG-005-discipleshipbot.md. PR #16. |
| [ ] | REV-003 | REVIEW | Codex / codex/review-eng-005 / 2026-09-12 | REV-002 | Review ENG-005; retain unresolved errors across stores, keep every failed store recoverable and report clipboard outcomes. Scope: index.html, save-feedback helper/tests and browser regressions. |
