...
| [ ] | ENG-004 | REVIEW | DiscipleshipBot / cursor/eng-004-export-preview-42be / 2026-09-11 | ENG-001, ENG-003 | Default Email Lesson to the current lesson; explicit optional course scope and visible preview before opening a mail draft. Include only selected responses, never auto-send. Verify other lessons' prayers stay out of a current-lesson export. Add tests for scope and text encoding. Evidence: logs/2026-09-11-ENG-004-discipleshipbot.md. PR #14. |
| [ ] | REV-002 | REVIEW | Codex / codex/review-eng-004 / 2026-09-11 | REV-001 | Review ENG-004 at c04efb72; correct radio-group keyboard focus trap in index.html and add browser regression checks; update review log and next assignment. |
