...
| [ ] | ENG-005 | ACTIVE | DiscipleshipBot / cursor/eng-005-save-feedback-2d2c / 2026-09-12 | ENG-001 | Add Saving/Saved/Could not save feedback and preserve edits on storage failure. Verify quota/unavailable-storage behavior and recovery. Preserve the REV-001 failed-load write guard. Explain when edits are only in memory; offer recovery without overwriting the unreadable raw copy. |
