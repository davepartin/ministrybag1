...
1. **ENG-006a:** cleared to start: versioned backup download only. ENG-005 is reviewed and corrected in REV-003.
2. **SEC-001:** remove the exposed credential dependency before broader release.
3. **ENG-006b/c:** restore preview, then restore; each waits for its preceding review.
4. **ENG-002:** still awaits Dave's artwork/actual-phone review. Claude's PR #17 awaits a separate lesson review.

Dave reports Claude is actively drafting L-202-08 and L-202-09 locally. Reserve those lesson files and their dedicated assets for Claude. Grokbot claimed ENG-005 on `cursor/eng-005-save-feedback-2d2c`. The coordinator owns shared board/handoff updates during this parallel work; workers write their own logs. Login/provider selection remains deferred to DATA-001.
...
| [ ] | ENG-006a | TODO | - | ENG-001, ENG-005 | Parent ENG-006. Versioned backup download for answers, completion and reading data, including retained ambiguity metadata and explicit store/load status. Show counts and scope; do not label an unreadable/partial store complete. Verify actual downloaded bytes and unsaved in-memory edits. No restore writes, uploads or login. |
| [ ] | ENG-006b | TODO | - | ENG-006a | Parent ENG-006. Strict file validation and read-only restore preview: format/version/size/type checks, counts/conflicts/unknown keys, clear selection semantics, unchanged storage on invalid input or cancel. Preserve compatibility with the 006a format and clearly distinguish old recovery snapshots. No restore writes. |
...
| L-202-08 | REVIEW | Claude / claude/l-202-08-09-marriage-purity / 2026-09-11 | external draft | pending | pending | pending | unrecorded | pending | PR #17 submitted for review; main JSON remains empty. Revise pastoral scope, sources, story/tool and closing, then integrate on review branch. See reviews/2026-09-11-202-08-09-drafts.md. |
| L-202-09 | REVIEW | Claude / claude/l-202-08-09-marriage-purity / 2026-09-11 | external draft | pending | pending | pending | unrecorded | pending | PR #17 submitted for review; main JSON remains a stub. Revise sources, story/tool and closing, preserving saved identities. See reviews/2026-09-11-202-08-09-drafts.md. |
